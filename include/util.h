...
//add by huih@20150729 , generate index for server socket
int get_serverSocketIndex(void);

//add by huih@20150729, generate index for client socket
int get_clientSocketIndex(void);
void cause_segment(void);
...
//add by huih@20150807 judge current status
#define is_pause_mode (cf_pause_mode == P_PAUSE)
