...
pgbouncer_SOURCES = \
	...
	src/proto/backend.c \
	src/proto/common.c \
	src/proto/frontend.c \
	src/proto/protooutput.c \
	src/multhreads/clientthreads.c \
	src/multhreads/serverpool.c \
	src/multhreads/acceptthread.c \
	src/multhreads/pgthread.c \
	src/multhreads/vipthread.c \
        src/testserverpool.c \
	include/admin.h \
	include/bouncer.h \
	include/client.h \
	include/dnslookup.h \
...
#LIBS := /usr/local/libevent/lib/libevent.a
...
.PHONY: tags
tags:
	ctags src/*.c include/*.h lib/usual/*.[ch] src/proto/*.c include/proto/*.h
